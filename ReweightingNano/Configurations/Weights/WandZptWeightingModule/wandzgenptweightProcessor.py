...
class wandzgenptweight(Module):
	...
	def analyze(self, event):
		ewkWWeight = ewkZWeight = qcdWWeight = qcdZTo2LWeight = ewkWDeborahsWeight = ewkZDeborahsWeight = WnnloWeight = ZnnloWeight = combinedWZgenPtWeight = combinedWZgenPtDeborahWeight = 1
